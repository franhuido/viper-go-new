...
const FilterBar: React.FC<FilterBarProps> = ({ onFilterChange }) => {
  ...
  return (
    <nav className="fixed top-6 max-lg:top-5 right-4 w-auto max-w-[calc(100vw-320px)] lg:max-w-[calc(100vw-400px)] min-w-[280px] overflow-hidden">
      <div 
        ref={scrollRef} 
        className="flex items-center gap-2 pr-12 overflow-x-auto scrollbar-hide pb-1 w-full mx-auto"
      ...
      >
        ...
        <button
          ...
          className={`flex h-10 max-lg:h-8 justify-center items-center gap-[5px] shadow-[0_4px_8px_0_rgba(0,0,0,0.25)] px-[15px] max-lg:px-3 py-2 max-lg:py-1.5 rounded-[20px] border-2 border-solid transition-colors whitespace-nowrap ${
            filter.active 
      ...
      <button
        ...
        className="absolute -right-1 top-1/2 -translate-y-1/2 flex h-8 w-8 justify-center items-center rounded-full bg-white border-2 border-[#D9D9D9] shadow-[0_4px_8px_0_rgba(0,0,0,0.25)] hover:border-[#F17431] hover:bg-orange-50 z-10"
